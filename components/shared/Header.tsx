  ...
  return (
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-zinc-200 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2.5 rtl:space-x-reverse">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 rtl:space-x-reverse bg-zinc-100 hover:bg-zinc-200 border border-zinc-300 px-3 py-2 rounded-xl text-xs font-bold text-zinc-900 transition-all shadow-sm"
          ...
          {/* User Role Tag */}
          <div className="flex items-center space-x-2 rtl:space-x-reverse bg-zinc-100 border border-zinc-300 px-3 py-2 rounded-xl text-xs font-bold text-zinc-900">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 rtl:space-x-reverse bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 px-3 py-2 rounded-xl text-xs font-bold transition-all shadow-sm"
            title={t('logout')}
          >
      ...
      {(isMainShop || isBodyShop) && (
        <div className="bg-slate-100 border-t border-slate-200 overflow-x-auto">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-2 flex items-center space-x-2 rtl:space-x-reverse min-w-max text-xs font-bold">
